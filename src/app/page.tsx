          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <Badge variant="secondary" className="mt-2 bg-shifu-gold/90">On fire! 🔥</Badge>
              </CardContent>
            </Card>
          </div>
                  ...
                  { topic: "Product Analytics", duration: "3 hours", energy: 9, model: "Claude 4 Sonnet" }
                    ...
                    <div key={i} className="flex items-center justify-between p-4 border rounded-lg">
                      <div className="space-y-1">
                        ...
                        <p className="text-sm text-shifu-sage/70">{session.duration} • Energy: {session.energy}/10</p>
                      </div>
